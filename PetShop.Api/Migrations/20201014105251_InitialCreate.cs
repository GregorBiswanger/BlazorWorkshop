    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(1989, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Nuremberg", "Lorem ipsum", 2, "max.vogel@petshop.de", null, "Max", 0, 1, new DateTime(2015, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Vogel", 50.850299999999997, 4.3517000000000001, 1, "123456789", false, "Sesamstraße 17", "1000" });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "BirthDate", "City", "Comment", "CountryId", "Email", "ExitDate", "FirstName", "Gender", "JobCategoryId", "JoinedDate", "LastName", "Latitude", "Longitude", "MaritalStatus", "PhoneNumber", "Smoker", "Street", "Zip" },
                values: new object[] { 2, new DateTime(1979, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Amsterdam", "Lorem ipsum", 3, "petra.wuff@petshop.de", null, "Petra", 1, 1, new DateTime(2017, 12, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Wuff", 50.850299999999997, 4.3517000000000001, 0, "987654321", false, "New Street. 123", "2000" });
